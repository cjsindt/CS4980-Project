...
For example, calling "containment_closing_1('New York')" will generate a time-series stacked-bar plot of all policies within New York that meet a threshold of at least 1 (According to the OxCGRT rating scale for that policy).
